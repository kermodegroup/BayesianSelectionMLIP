...
###
# Run GAP fits on datasets generated by generate_sampled_datasets.py

# methods = method_comparison_plots produces the GAP models comparable with those in Figs. 1 & 2
# methods = descriptor_comparison_plots produces the GAP models comparable with those in Figs. 3 & 4
